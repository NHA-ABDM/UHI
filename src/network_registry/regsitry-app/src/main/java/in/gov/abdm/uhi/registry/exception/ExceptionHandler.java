...
public class ExceptionHandler {
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(InvalidInputFormate.class)
	public ResponseEntity<ErrorDetails> InvalidInput(InvalidInputFormate exception,
			WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails();
		errorDetails.setMessage(exception.getMessage());
		errorDetails.setPath(webRequest.getDescription(false));
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(RegistryException.class)
	public ResponseEntity<ErrorDetails> unathorizeException(RegistryException exception,
			WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails();
		errorDetails.setMessage(exception.getMessage());
		errorDetails.setPath(webRequest.getDescription(false));
		errorDetails.setStatus(HttpStatus.UNAUTHORIZED.toString());
		errorDetails.setTimestamp(new Date());
