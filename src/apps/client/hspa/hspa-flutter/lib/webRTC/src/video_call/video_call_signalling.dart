...
class VideoCallSignalling {
  ...
  VideoCallSignalling({
    ...
    debugPrint('VideoCallSignalling chat id is $chatId');
  }
  ...
  void onMessage(messageContent, ChatMessageDhpModel chatMessage) async {
    ...
    switch (messageContent['type']) {
      ...
      debugPrint('In Ready ${chatMessage.message?.intent?.chat?.sender?.person?.name}');
  ...
  postMessageAPI(message) async {
    ...
    debugPrint('Sending post message API request body is  ${chatMessageModel.toJson()} **********');
  ...
  Future<Session> _createSession(Session? session,
    ...
    _localStream ??= await createLocalStream(media, screenSharing);
