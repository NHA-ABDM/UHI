...
class VideoCallState extends State<VideoCall> {
  ...
  @override
  void initState() {
    debugPrint('in initState of Video Call');
    super.initState();
    // Get arguments
    ...
    _selfId = doctorHprId;
    debugPrint('doctorHprId is $doctorHprId, patientAbhaId is $patientAbhaId, patientUri is $patientUri');
    Wakelock.enable();
    startVideoCall();
  }
  ...
  void _connect() {
    ...
    _videoCallSignalling?.onCallStateChange =
      ...
      debugPrint('In onCallStateChange $state');
      switch (state) {
        ...
        case CallState.callStateBye:
          debugPrint('In Video Call CallState.callStateBye');
          if (_waitAccept) {
