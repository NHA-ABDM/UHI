...
class AppStrings {
  ...
  String errorFileSize({required String fileSize}) => 'errorFileSize'.tr(args: [fileSize]);
  String alertSendFile({required String fileName}) => 'alertSendFile'.tr(args: [fileName]);
  String labelInDoctorsWaitingRoom({required String doctorName}) => 'labelInDoctorsWaitingRoom'.tr(args: [doctorName]);
  String labelWaitInDoctorsWaitingRoom({required String doctorName}) => 'labelWaitInDoctorsWaitingRoom'.tr(args: [doctorName]);
  ...
  static List<String> specialities = <String>[
    ...
    'Gynecology & Ultrasonology',
    'Head & Neck Surgery',
    'Head & Neck Surgical Oncology',
    'Hepato Pancreato Biliary Surgery',
    'Infectious Disease medicine',
    'Internal Medicine',
    'Internal Medicine & Diabetics',
    'Neuro Surgery',
    'Resident Physicians',
    ...
    'Paediatrics Surgery',
    'Pathology',
    'Peadodontology (Child Dentistry)',
  ...
  static List<String> specialitiesOld = <String>[
    'MD - Anaesthesiology',
    'MD - Biochemistry',
    'MD - Community Health',
    'MD - Dermatology',
