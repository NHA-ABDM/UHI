...
class TodayAppointmentPage extends StatefulWidget {
  const TodayAppointmentPage({Key? key, required this.appointmentsController, required this.isTeleconsultation}) : super(key: key);
...
class _TodayAppointmentPageState extends State<TodayAppointmentPage> with AutomaticKeepAliveClientMixin{
