...
class UpcomingAppointmentsPage extends StatefulWidget {
  const UpcomingAppointmentsPage({Key? key, required this.appointmentsController, required this.isTeleconsultation}) : super(key: key);
...
class _UpcomingAppointmentsPageState extends State<UpcomingAppointmentsPage> with AutomaticKeepAliveClientMixin{
    ...
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return AppointmentsView(
            ...
            cancelAppointment: () {
              debugPrint('In cancel upcoming appointment');
              setState(() {
