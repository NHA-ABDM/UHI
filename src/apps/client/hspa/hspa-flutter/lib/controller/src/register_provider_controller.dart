...
class RegisterProviderController extends GetxController with ExceptionHandler {
        ...
        if (value == null) {
          ...
          if (response != null) {
            RegisterProviderResponse? registerProviderResponse =
                RegisterProviderResponse.fromJson(json.decode(response));
            debugPrint(
                'Register provider response parsed successfully ${registerProviderResponse.uuid}');
            await processAndSaveDoctorProfile(
                registerProviderResponse, requestBody);
  ...
  Future<void> processAndSaveDoctorProfile(
      RegisterProviderResponse registerProviderResponse,
      ...
      switch (attributeMap['attributeType']) {
        ...
        case ProviderAttributesLocal.isPhysicalConsultation:
          isPhysicalConsultation =
              attributeMap['value'].toLowerCase() == 'true';
          break;
      }
    }
