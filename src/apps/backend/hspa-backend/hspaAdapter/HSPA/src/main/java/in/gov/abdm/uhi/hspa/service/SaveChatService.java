...
public class SaveChatService implements ChatDataDb {
    ...
    public SaveChatService(MessagesRepository messagesRepo, ChatUserRepository chatUserRepository, ModelMapper modelMapper, UserTokenRepository userTokenRepository, PushNotificationService pushNotificationService, PublicKeyRepository publicKeyRepository, SharedKeyRepository sharedKeyRepo, FileStorageService fileStorageService, WebClient webClient, ObjectMapper objectMapper) {
    ...
    public MessagesModel saveMessage(Request request) {
    ...
    public UserTokenModel saveUserToken(String requestokenString) throws JsonProcessingException {

        RequestTokenDTO requestTokenDTO = objectMapper.readValue(requestokenString, RequestTokenDTO.class);
        UserTokenModel ut = new UserTokenModel();
        String userid = requestTokenDTO.getUserName() + "|" + requestTokenDTO.getDeviceId();
        ut.setUserId(userid);
        ut.setUserName(requestTokenDTO.getUserName());
        ut.setToken(requestTokenDTO.getToken());
        ut.setDeviceId(requestTokenDTO.getDeviceId());
