...
public class Crypt {
    ...
    public HeaderDTO extractAuthorizationParams(String headerName, Map<String, String> httpRequestHeaders, Request request) throws JsonProcessingException {
        String authHeader = httpRequestHeaders.get(headerName);
        LOGGER.info("{} | Action:: {} | Authorization {}", request.getContext().getMessageId(), request.getContext().getAction(), authHeader);
