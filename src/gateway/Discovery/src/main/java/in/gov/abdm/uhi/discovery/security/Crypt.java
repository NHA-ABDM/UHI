...
public class Crypt {
	...
	public static void main(String args[]) throws JsonProcessingException, InvalidKeyException,
		...
		ctx.setConsumerUri("http://100.65.158.41:8901/api/v1/euaService");
		ctx.setMessageId("c8f9ad70-034b-11ed-a6d6-c13d491ee158");
		ctx.setTimestamp("2022-07-14T08:05:55.252760Z");
		ctx.setTransactionId("8f9ad70-034b-11ed-a6d6-c13d491ee158");
		...
		agent.setName("mohit");
		fulfilment.setAgent(agent);
		fulfilment.setType("Teleconsultation");
		intent.setFulfillment(fulfilment);
		...
		payload = """
				{"message":{"intent":{"fulfillment":{"type":"Teleconsultation","agent":{"name":"mohit"}}},"order":null,"catalog":null,"order_id":null},"context":{"domain":"nic2004:85111","country":"IND","city":"std:080","action":"search","timestamp":"2022-07-14T08:05:55.252760Z","core_version":"0.7.1","consumer_id":"eua-nha","consumer_uri":"http://100.65.158.41:8901/api/v1/euaService","transaction_id":"8f9ad70-034b-11ed-a6d6-c13d491ee158","message_id":"c8f9ad70-034b-11ed-a6d6-c13d491ee158"}}""";
		...
		String signature = new Crypt("BC").generateSignature(payload, EdDSAParameterSpec.Ed25519, priv);
		System.out.println(signature);

		Map<String, String> params = new Crypt("BC").generateAuthorizationParams("eua-nha", "pk23777", payload, priv);
	...
	public void testNirmal(PrivateKey pkey, String pubkey, Map<String, String> header, String payload)
		...
		System.out.println("Nirmal Test|" + processSignature(signature, hashedSigningString, pubkey, created, expires));
	}
}